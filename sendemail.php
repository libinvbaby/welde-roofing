...
$mail->Subject = 'New Contact Form Submission from Roofing Landing Page';
$mail->Body = "
<table style='border-collapse: collapse; width: 100%;'>
  <tr style='border: 1px solid black; background-color: #f2f2f2;'>
    ...
    <th style='padding: 8px; text-align: left; border: 1px solid black;'>city</th>
  ...
  <tr style='border: 1px solid black;'>
    ...
    <td style='padding: 8px; text-align: left; border: 1px solid black;'>$city</td>
